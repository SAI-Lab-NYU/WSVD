...
def evaluator(model, testenc, dev, args, tokenizer, image_processor):
    ...
    def infer_data_llava(lm, args, verbose=False):
        ...
        if args.case_study:
            ...
            out_file = args.save_path + f'/ocrbench_eval_rank{rank}.pkl'
        ...
        if rank == 0:
            ...
            for r in range(world_size):
                rank_file = args.save_path + f'/ocrbench_eval_rank{r}.pkl'
                if os.path.exists(rank_file):
                    merged_results.update(load(rank_file))

            # Dump merged results
            merged_out_file = args.save_path + '/ocrbench_eval.pkl'
    ...
    if rank == 0:
        ...
        result_file = args.save_path + '/ocrbench_result.xlsx'
        data_all = load(args.save_path + '/ocrbench_eval.pkl')
